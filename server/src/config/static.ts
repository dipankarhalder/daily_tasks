...
export const readOnlyEmail =
  "It's read only field, can't change the email";
export const succCreated =
  'Successfully created the records';
export const succUpdate =
  'Successfully updated the records';
export const succDelete =
